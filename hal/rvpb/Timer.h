...
typedef struct Timer_t
{
	...
	TimerXControl	timerxcontrol;	// 0x08
	uint32_t	timerxintclr;	// 0x0C
	TimerXRIS	timerxris;	// 0x10
	TimerXMIS	timerxmis;	// 0x14
